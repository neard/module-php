...
"~NEARD_WIN_PATH~\bin\php\php5.4.40\php.exe" -d auto_append_file="" -d auto_prepend_file="" -d include_path="'~NEARD_WIN_PATH~\bin\php\php5.4.40\pear\pear'" -f "~NEARD_WIN_PATH~\bin\php\php5.4.40\pear\phpcs" -- %*
