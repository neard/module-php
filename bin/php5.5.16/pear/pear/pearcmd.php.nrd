...
if ('~NEARD_WIN_PATH~\bin\php\php5.5.16\pear\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('~NEARD_WIN_PATH~\bin\php\php5.5.16\pear\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
