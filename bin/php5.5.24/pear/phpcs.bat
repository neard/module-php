...
"~NEARD_WIN_PATH~\bin\php\php5.5.24\php.exe" -d auto_append_file="" -d auto_prepend_file="" -d include_path="'~NEARD_WIN_PATH~\bin\php\php5.5.24\pear\pear'" -f "~NEARD_WIN_PATH~\bin\php\php5.5.24\pear\phpcs" -- %*
