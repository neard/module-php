...
"~NEARD_WIN_PATH~\bin\php\php5.3.28\php.exe" -d auto_append_file="" -d auto_prepend_file="" -d include_path="'~NEARD_WIN_PATH~\bin\php\php5.3.28\pear\pear'" -f "~NEARD_WIN_PATH~\bin\php\php5.3.28\pear\phpcs" -- %*
